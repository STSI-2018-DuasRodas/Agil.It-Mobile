...
var HourWorkedPage = /** @class */ (function () {
    function HourWorkedPage(viewUtils) {
    ...
    HourWorkedPage.prototype.confirmAppointments = function () {
        var hourAponted = {};
    ...
    HourWorkedPage.prototype.initializingObject = function () {
    };
    HourWorkedPage.ctorParameters = function () { return [
